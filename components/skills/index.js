        ...
        <div className="container">
          ...
          <div className="container-skills">
            <div className="container-skills-soft">
              ...
              <ul>
                {[
                  ...
                  <li className="grey">
                    <Icon icon="akar-icons:circle" color="#0E899F" /> {skill}
                  </li>;
                })}

                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" /> Organization
                </li>
                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" />{" "}
                  Dependability
                </li>
              </ul>
            </div>
            <div className="container-skills-hard">
              ...
              <ul>
                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" /> Programming
                </li>
                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" /> Wireframes
                </li>
                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" /> User
                  interface design
                </li>
                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" /> Debugging
                </li>
                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" /> Bilingual /
                  Multilingual
                </li>
                <li className="grey">
                  <Icon icon="akar-icons:circle" color="#0E899F" /> Sales
                </li>
              </ul>
            </div>
